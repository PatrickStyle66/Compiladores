...
_lr_productions = [
  ...
  ('empty -> <empty>','empty',0,'p_empty','Syntatic.py',13),
  ('declara -> VAR dvar maisdc','declara',3,'p_declara','Syntatic.py',18),
  ('declara -> empty','declara',1,'p_declara','Syntatic.py',19),
  ('maisdc -> DOTCOMMA contadc','maisdc',2,'p_maisdc','Syntatic.py',23),
  ('contadc -> dvar maisdc','contadc',2,'p_contadc','Syntatic.py',27),
  ('contadc -> empty','contadc',1,'p_contadc','Syntatic.py',28),
  ('dvar -> variaveis TYPE tipovar','dvar',3,'p_dvar','Syntatic.py',32),
  ...
  ('variaveis -> ID maisvar','variaveis',2,'p_variaveis','Syntatic.py',44),
  ('maisvar -> COMMA maisvar','maisvar',2,'p_maisvar','Syntatic.py',49),
  ('maisvar -> empty','maisvar',1,'p_maisvar','Syntatic.py',50),
  ('rotina -> procedimento','rotina',1,'p_rotina','Syntatic.py',55),
  ('rotina -> funcao','rotina',1,'p_rotina','Syntatic.py',56),
  ('rotina -> empty','rotina',1,'p_rotina','Syntatic.py',57),
  ('procedimento -> PROCEDURE ID parametros DOTCOMMA corpo DOTCOMMA rotina','procedimento',7,'p_procedimento','Syntatic.py',61),
  ('funcao -> FUNCTION ID parametros TWODOT tipofuncao DOTCOMMA corpo DOTCOMMA rotina','funcao',9,'p_funcao','Syntatic.py',64),
  ('parametros -> LPAREN listaparametros RPAREN','parametros',3,'p_parametros','Syntatic.py',68),
  ('parametros -> empty','parametros',1,'p_parametros','Syntatic.py',69),
  ('listaparametros -> listaid TWODOT tipovar contlistapar','listaparametros',4,'p_listaparmetros','Syntatic.py',73),
  ('contlistapar -> DOTCOMMA listaparametros','contlistapar',2,'p_contlistapar','Syntatic.py',76),
  ('contlistapar -> empty','contlistapar',1,'p_contlistapar','Syntatic.py',77),
  ('listaid -> ID contlistaid','listaid',2,'p_listaid','Syntatic.py',81),
  ('contlistaid -> DOTCOMMA listaparametros','contlistaid',2,'p_contlistaid','Syntatic.py',85),
  ('contlistaid -> empty','contlistaid',1,'p_contlistaid','Syntatic.py',86),
  ('tipofuncao -> INTEGER','tipofuncao',1,'p_tipofuncao','Syntatic.py',91),
  ('tipofuncao -> REAL','tipofuncao',1,'p_tipofuncao','Syntatic.py',92),
  ('tipofuncao -> PILHAINTEGER','tipofuncao',1,'p_tipofuncao','Syntatic.py',93),
  ('tipofuncao -> PILHAREAL','tipofuncao',1,'p_tipofuncao','Syntatic.py',94),
  ('sentencas -> comando maissentencas','sentencas',2,'p_sentencas','Syntatic.py',98),
  ('maissentencas -> DOTCOMMA contsentencas','maissentencas',2,'p_maissentencas','Syntatic.py',101),
  ('contsentencas -> sentencas','contsentencas',1,'p_contsentencas','Syntatic.py',105),
  ('contsentencas -> empty','contsentencas',1,'p_contsentencas','Syntatic.py',106),
  ('varread -> ID maisvarread','varread',2,'p_varread','Syntatic.py',110),
  ('maisvarread -> COMMA varread','maisvarread',2,'p_maisvarread','Syntatic.py',114),
  ('maisvarread -> empty','maisvarread',1,'p_maisvarread','Syntatic.py',115),
  ('varwrite -> ID maisvarwrite','varwrite',2,'p_varwrite','Syntatic.py',119),
  ('maisvarwrite -> COMMA varwrite','maisvarwrite',2,'p_maisvarwrite','Syntatic.py',123),
  ('maisvarwrite -> empty','maisvarwrite',1,'p_maisvarwrite','Syntatic.py',124),
  ('comando -> READ LPAREN varread RPAREN','comando',4,'p_comando','Syntatic.py',129),
  ('comando -> IF LPAREN condicao RPAREN THEN BEGIN sentencas END pfalsa','comando',9,'p_comando','Syntatic.py',130),
  ('comando -> FOR ID ATTR expressao TO expressao DO BEGIN sentencas END','comando',10,'p_comando','Syntatic.py',131),
  ('comando -> atribuicao','comando',1,'p_comando','Syntatic.py',132),
  ('comando -> WRITE LPAREN varwrite RPAREN','comando',4,'p_comando','Syntatic.py',133),
  ('comando -> WHILE LPAREN condicao RPAREN DO BEGIN sentencas END','comando',8,'p_comando','Syntatic.py',134),
  ('comando -> REPEAT sentencas UNTIL LPAREN condicao RPAREN','comando',6,'p_comando','Syntatic.py',135),
  ('comando -> chamadaprocedimento','comando',1,'p_comando','Syntatic.py',136),
  ('atribuicao -> ID ATTR expressao','atribuicao',3,'p_atribuicao','Syntatic.py',140),
  ('chamadaprocedimento -> ID argumentos','chamadaprocedimento',2,'p_chamadaprocedimento','Syntatic.py',144),
  ('argumentos -> LPAREN listaarg RPAREN','argumentos',3,'p_argumentos','Syntatic.py',148),
  ('argumentos -> empty','argumentos',1,'p_argumentos','Syntatic.py',149),
  ('listaarg -> expressao contlistaarg','listaarg',2,'p_listaarg','Syntatic.py',153),
  ('contlistaarg -> COMMA listaarg','contlistaarg',2,'p_contlistaarg','Syntatic.py',157),
  ('contlistaarg -> empty','contlistaarg',1,'p_contlistaarg','Syntatic.py',158),
  ('condicao -> relacao LPAREN expressaonum COMMA expressaonum RPAREN','condicao',6,'p_condicao','Syntatic.py',163),
  ('condicao -> relacao LPAREN expressaopilha COMMA expressaopilha RPAREN','condicao',6,'p_condicao','Syntatic.py',164),
  ('pfalsa -> ELSE BEGIN sentencas END','pfalsa',4,'p_pfalsa','Syntatic.py',169),
  ('pfalsa -> empty','pfalsa',1,'p_pfalsa','Syntatic.py',170),
  ('relacao -> EQUALS','relacao',1,'p_relacao','Syntatic.py',175),
  ('relacao -> GREAT','relacao',1,'p_relacao','Syntatic.py',176),
  ('relacao -> LESS','relacao',1,'p_relacao','Syntatic.py',177),
  ('relacao -> GREATEQ','relacao',1,'p_relacao','Syntatic.py',178),
  ('relacao -> LESSEQ','relacao',1,'p_relacao','Syntatic.py',179),
  ('relacao -> DIFFERENT','relacao',1,'p_relacao','Syntatic.py',180),
  ('expressao -> expressaonum','expressao',1,'p_expressao','Syntatic.py',185),
  ('expressao -> expressaopilha','expressao',1,'p_expressao','Syntatic.py',186),
  ('expressaonum -> termo','expressaonum',1,'p_expressaonum','Syntatic.py',191),
  ('expressaonum -> ID argumentos','expressaonum',2,'p_expressaonum','Syntatic.py',192),
  ('operando -> ID','operando',1,'p_operando','Syntatic.py',197),
  ('operando -> integernum','operando',1,'p_operando','Syntatic.py',198),
  ('operando -> realnum','operando',1,'p_operando','Syntatic.py',199),
  ('operando -> operador LPAREN operando COMMA operando RPAREN','operando',6,'p_operando','Syntatic.py',200),
  ('operador -> PLUS','operador',1,'p_operador','Syntatic.py',205),
  ('operador -> MINUS','operador',1,'p_operador','Syntatic.py',206),
  ('operador -> TIMES','operador',1,'p_operador','Syntatic.py',207),
  ('operador -> DIVIDE','operador',1,'p_operador','Syntatic.py',208),
  ('operador -> DIVIDER','operador',1,'p_operador','Syntatic.py',209),
  ('termo -> operador LPAREN operando COMMA operando RPAREN','termo',6,'p_termo','Syntatic.py',214),
  ('termo -> ID','termo',1,'p_termo','Syntatic.py',215),
  ('termo -> integernum','termo',1,'p_termo','Syntatic.py',216),
  ('termo -> realnum','termo',1,'p_termo','Syntatic.py',217),
  ('expressaopilha -> oppilha LPAREN conteudo RPAREN','expressaopilha',4,'p_expressaopilha','Syntatic.py',222),
  ('expressaopilha -> CONCATENA LPAREN conteudo COMMA conteudo RPAREN','expressaopilha',6,'p_expressaopilha','Syntatic.py',223),
  ('expressaopilha -> INVERTE LPAREN conteudo RPAREN','expressaopilha',4,'p_expressaopilha','Syntatic.py',224),
  ('conteudo -> HASHTAG HASHTAG','conteudo',2,'p_conteudo','Syntatic.py',229),
  ('conteudo -> HASHTAG integernum integernumcont HASHTAG','conteudo',4,'p_conteudo','Syntatic.py',230),
  ('conteudo -> HASHTAG realnum realnumcont HASHTAG','conteudo',4,'p_conteudo','Syntatic.py',231),
  ('integernumcont -> COMMA integernum integernumcont','integernumcont',3,'p_integernumcont','Syntatic.py',236),
  ('integernumcont -> empty','integernumcont',1,'p_integernumcont','Syntatic.py',237),
  ('realnumcont -> COMMA realnum realnumcont','realnumcont',3,'p_realnumcont','Syntatic.py',242),
  ('realnumcont -> empty','realnumcont',1,'p_realnumcont','Syntatic.py',243),
  ('oppilha -> INPUT','oppilha',1,'p_oppilha','Syntatic.py',248),
  ('oppilha -> OUTPUT','oppilha',1,'p_oppilha','Syntatic.py',249),
  ('oppilha -> LENGTH','oppilha',1,'p_oppilha','Syntatic.py',250),
  ('integernum -> NUMBER','integernum',1,'p_integernum','Syntatic.py',254),
  ('realnum -> RNUMBER','realnum',1,'p_realnum','Syntatic.py',257),
]
